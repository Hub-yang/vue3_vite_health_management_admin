<template>
  <div class="footer-main">
    <el-row :gutter="20">
      <el-col :span="4"><el-link>With Underline</el-link></el-col>
      <el-col :span="4"><el-link>With Underline</el-link></el-col>
      <el-col :span="4"><el-link>With Underline</el-link></el-col>
      <el-col :span="4"><el-link>With Underline</el-link></el-col>
      <el-col :span="4"><el-link>With Underline</el-link></el-col>
    ...
    <el-row>
      <el-col :span="24">Copyright © 2022 Soft by Creative Tim.</el-col>
    </el-row>
  </div>
</template>
